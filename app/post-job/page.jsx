...
export default function PostJobPage() {
  ...
  useEffect(() => {
    if (isLoaded && user && user.publicMetadata?.role === 'RECRUITER') {
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <Show when="signed-out">
          <div className="rounded-3xl bg-white p-12 text-center shadow-sm border border-slate-200">
            <h1 className="text-3xl font-bold text-slate-900 mb-4">Recruiters Only</h1>
            <p className="text-lg text-slate-500 mb-8">You must be signed in as a Recruiter to post jobs.</p>
